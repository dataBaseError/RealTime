...
int main(int argc, char** argv) {
    ...
    while (true) {
        ...
        while (true) {
            ...
            if ((value == "101 state[0x1000]" && direction == TrainController::FORWARD) || (value == "101 state[0x4000]" && direction == TrainController::FORWARD)) {
                command = controller.setSwitch(TrainController::F1, destination);
                break;
            } else if ((value == "100 state[0x2]" && direction == TrainController::FORWARD) || (value == "100 state[0x4]" && direction == TrainController::FORWARD)) {
                command = controller.setSwitch(TrainController::F2, destination);
                break;
            } else if ((value == "101 state[0x200]" && direction == TrainController::BACKWARD) || (value == "101 state[0x400]" && direction == TrainController::BACKWARD)) {
                command = controller.setSwitch(TrainController::J1, destination);
                break;
            } else if ((value == "100 state[0x20]" && direction == TrainController::BACKWARD) || (value == "100 state[0x20]" && direction == TrainController::BACKWARD)) {
